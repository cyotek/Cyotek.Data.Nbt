...
namespace Cyotek.Data.Nbt.Tests
{
  public class TestBase
  {
    ...
    private static readonly byte[] _sampleByteArray = new byte[]
                                                      {
                                                        0,
                                                        62,
                                                        34,
    ...
    protected TagCompound CreateComplexData()
    {
      ...
      root.Value.Add("byteArrayTest (the first 1000 values of (n*n*255+n*7)%100, starting with n=0 (0, 62, 34, 16, 8, ...))", _sampleByteArray);
    ...
    protected void WriteTest<T, T2>(Func<Stream, T> createWriter) where T : TagWriter where T2 : ITagReader, new()
    {
      ...
      target.WriteTag("byteArrayTest (the first 1000 values of (n*n*255+n*7)%100, starting with n=0 (0, 62, 34, 16, 8, ...))", _sampleByteArray);
